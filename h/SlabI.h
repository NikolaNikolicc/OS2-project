...
#ifndef PROJECT_BASE_V1_1_SLABI_H
#define PROJECT_BASE_V1_1_SLABI_H
...
int kmem_cache_free(kmem_cache_t *cachep, void *objp); // Deallocate one object from cache
...
#endif //PROJECT_BASE_V1_1_SLABI_H
